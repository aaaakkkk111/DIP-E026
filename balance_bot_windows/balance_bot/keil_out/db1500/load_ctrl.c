 ...
 * Generated 2026-09-16 14:55   (motor dead band 1500) by scripts/export_keil.py -- do not edit by hand.
 *
 * THIS BUILD IS FOR A MOTOR DEAD BAND OF ABOUT 1500 COUNTS.
 *   Measure yours first (see the README), then pick the matching folder.
 *
 *   >>> SET  MOTOR_IGNORE_PULSE  TO  1500  IN APP/app_motor.c  <<<
 ...
 *   Measured chatter at this dead band: NORMAL empty 18.9 / 2kg 2.5,  HEAVY empty 51.2 / 2kg 10.3
 *   Detection margin: 2.23x
 *
 ...
 *
 * BEFORE YOU FLASH
 *   Balance_Kp is 4.0x the factory value.  Follow the staged bring-up
 *   list in load_ctrl_README.md, and do the threshold calibration -- a
 *   2.23x margin will not survive the difference between this car and
 *   the simulation.
 */
...
LD_Gains ld_g_normal = { 38400.0f, 48.0f, 11000.0f, 92.0f, 1400.0f, 20.0f };
LD_Gains ld_g_heavy  = { 38400.0f, 120.0f, 15500.0f, 120.0f, 1400.0f, 20.0f };
...
float LD_LOADED_BELOW = 6.8f;
float LD_EMPTY_ABOVE  = 23.0f;
