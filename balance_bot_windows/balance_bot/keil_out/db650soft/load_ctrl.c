 ...
 * Generated 2026-09-16 14:55   (motor dead band 650) by scripts/export_keil.py -- do not edit by hand.
 *
 * THIS BUILD IS FOR A MOTOR DEAD BAND OF ABOUT 650 COUNTS.
 ...
 *   Measured chatter at this dead band: NORMAL empty 22.3 / 2kg 2.0,  HEAVY empty 51.0 / 2kg 16.3
 *   Detection margin: 1.77x
 *
 ...
 *
 * BEFORE YOU FLASH
 *   Balance_Kp is 2.5x the factory value.  Follow the staged bring-up
 *   list in load_ctrl_README.md, and do the threshold calibration -- a
 *   1.77x margin will not survive the difference between this car and
 *   the simulation.
 */
...
LD_Gains ld_g_normal = { 24000.0f, 48.0f, 8200.0f, 69.0f, 1400.0f, 20.0f };
...
float LD_LOADED_BELOW = 6.7f;
float LD_EMPTY_ABOVE  = 28.9f;
