 ...
 * Generated 2026-09-16 14:55   (motor dead band 1300) by scripts/export_keil.py -- do not edit by hand.
 *
 * THIS BUILD IS FOR A MOTOR DEAD BAND OF ABOUT 1300 COUNTS.
 ...
 *   Measured chatter at this dead band: NORMAL empty 20.9 / 2kg 2.7,  HEAVY empty 57.4 / 2kg 8.4
 *   Detection margin: 2.62x
 *
 ...
 *   2.62x margin will not survive the difference between this car and
 *   the simulation.
 */
...
float LD_LOADED_BELOW = 7.5f;
float LD_EMPTY_ABOVE  = 21.9f;
