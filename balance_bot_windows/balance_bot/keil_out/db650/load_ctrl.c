 ...
 *   Measured chatter at this dead band: NORMAL empty 46.8 / 2kg 8.1,  HEAVY empty 60.5 / 2kg 22.3
 *   Detection margin: 1.65x
 *
 ...
 *   1.65x margin will not survive the difference between this car and
 *   the simulation.
 */
...
float LD_LOADED_BELOW = 19.4f;
float LD_EMPTY_ABOVE  = 36.7f;
