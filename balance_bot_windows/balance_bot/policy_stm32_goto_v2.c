 ...
 * 生成时间 2026-09-12 23:26   训练步数 24,000
 *
 * 用法：
...
float Balance_Kp   = 22221.4f;   /* 孪生里的 balance_kp = 222.2 */
float Balance_Kd   = 33.3f;   /* 孪生里的 balance_kd = 0.3327 */
float Velocity_Kp  = 7291.8f;   /* 孪生里的 velocity_kp = 72.92 */
float Velocity_Ki  = 21.7f;   /* 孪生里的 velocity_ki = 0.2165 */
float Turn_Kp      = 9520.1f;   /* 孪生里的 turn_kp = 95.2 */
float Turn_Kd      = 37.3f;   /* 孪生里的 turn_kd = 0.3727 */
...
#define NAV_KV      0.3410f   /* 距离 -> 速度，1/s */
#define NAV_KW      0.7920f   /* 方位角 -> 偏航，1/s */
#define NAV_V_MAX   0.550f
#define NAV_W_MAX   1.200f
#define NAV_ARRIVE  0.100f   /* m，进这个圈算到了 */
