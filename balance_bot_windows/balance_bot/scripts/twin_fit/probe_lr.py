...
CASES = [("基线 fit9b", {})]
for lrs in (10.0, 25.0, 50.0, 90.0, 150.0):
    CASES.append(("左右死区差 %.0f" % lrs, dict(lrs=lrs)))
for lrs in (50.0, 90.0):
    CASES.append(("左右差 %.0f + 速度振动" % lrs, dict(lrs=lrs, vib=BASE["vib"] * 0.6, vibm=0.03)))
